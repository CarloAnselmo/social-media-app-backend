...
public class Driver {
	...
	public static void main(String[] args) throws IOException {
		...
		EmailService.sendMail("nikix73362@patmui.com", "Welcome back to Mochi Circle!",
				"You just logged in! Click this link to validate your account: "
						+ "<a href=\"http://localhost:8080/api/users/verify/\">http://localhost:8080/api/users/verify/"
						+ 6969 + "</a>.");
...
//		s3.putObject(PutObjectRequest.builder().bucket(bucket).key(key).build(), RequestBody.fromByteBuffer(getRandomByteBuffer(10000)));
		// PutObjectRequest request = new PutObjectRequest(bucket, fileName, new
		// File("C:\\Users\\carlo\\OneDrive\\Desktop\\Images\\Profile
		// Pictures\\dance_man.png")).withCannedAcl(CannedAccessControlList.PublicRead);
		// System.out.println(":)");
